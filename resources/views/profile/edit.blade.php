                        ...
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('country') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-email">{{ __('País') }}</label>
                                    <select name="country" class="form-control"required>
                                        @foreach ($todos_paises ?? '' as $item_p)

                                            <option value="{{$item_p->Slug}}"
                                                @if (auth()->user()->country == $item_p->Slug)
                                                    selected="selected"
                                                @endif
                                            > 
                                                {{$item_p->Country}}
                        ...
                        <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('old_password') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="password" name="old_password" id="input-current-password" class="form-control form-control-alternative{{ $errors->has('old_password') ? ' is-invalid' : '' }}" placeholder="{{ __('Senha atuakl') }}" value="" required>
